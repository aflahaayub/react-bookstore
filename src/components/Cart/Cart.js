...
export default function Cart(props){
  ...
  const cartItems = <ul className={styleClasses['cart-items']}>
  ...
  return <Modal onClose = {props.onClose}>
    ...
    <div className={styleClasses.actions}>
      <button className={styleClasses['button--alt']} onClick={props.onClose}>Close</button>
      {hasItems && <button className={styleClasses.button}>Order</button>
      }
    </div>
  </Modal>
}